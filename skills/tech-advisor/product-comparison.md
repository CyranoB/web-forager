...
Choose among technology products for the user's concrete use case.

## 1. Define the decision

Identify exact current products/models, use case, region, budget, priorities, required
ecosystem compatibility, and essential accessories or services. Continue immediately
...
Read current official specifications and prices, reputable head-to-head or use-case
reviews, and long-term user evidence. Verify model generations and regional availability.
Investigate total cost, longevity, support, and the real-world consequences of relevant
specification differences.

**Complete when:** every decision factor has current evidence for every viable option,
and missing or conflicting evidence is explicit.
...
**Complete when:** all must-haves and priorities are accounted for, prices match the
user's region and current models, material claims are cited, and the recommendation is
actionable.
